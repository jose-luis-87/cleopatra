gb2 = function(id, assetName, x0, y0, x1, y1, scale, angle, timeAnimation, timeDelay){
    ...
    this.events.onInputDown.add(function(){
                this.scale.setTo(1);
                this.kill();
                GamePlayManager.hitGb2(this.id, this.x, this.y);
...
gb2.prototype = Object.create(Phaser.Sprite.prototype);
gb2.prototype.constructor = gb2;

gb2.prototype.Appear = function(){
