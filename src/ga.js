ga = function(id, assetName, x0, y0, x1, y1, scale, angle, timeAnimation, timeDelay){
    Phaser.Sprite.call(this, game, 300, 300, assetName);
    this.animations.add('walk2', [0,1]);
    this.animations.play('walk2', 8, true);
    this.inputEnabled = true;
    this.events.onInputDown.add(function(){
                this.scale.setTo(1);
                this.kill();
                GamePlayManager.hitGa(this.id, this.x, this.y);
...
ga.prototype = Object.create(Phaser.Sprite.prototype);
ga.prototype.constructor = ga;

ga.prototype.Appear = function(){
